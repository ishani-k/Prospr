...
const colors = [
  "#A8DADC", // soft aqua
  "#F6BD60", // warm pastel yellow
  "#F28482", // muted coral
  "#84A59D", // gentle sage green
  "#F5CAC3", // blush pink
        ...
        <Card>
            ...
            <CardContent>
                <div className='space-y-4'>
                    ...
                    <p className='text-center text-muted-foreground py-4'>No recent transactions
                    </p> : (
