...
const BudgetProgress = ({initialBudget, currentExpenses}) => {
    ...
    (currentExpenses / initialBudget.amount) * 100 : 0
    ...
    useEffect(() => {
        ...
        {
            setIsEditing(false)
            toast.success("Budget updated successfully yay !")
        }
    }, [updatedBudget])
  ...
  return (
    <Card>
        <CardHeader className='flex flex-row items-center justify-baseline space-y-0 pb-2'>
            ...
            <div className='flex items-center gap-2 mt-1'>
                ...
                (<div className='flex items-center gap-2'>
                    ...
                    className='w-40' placeholder="Enter amount" autoFocus/>
